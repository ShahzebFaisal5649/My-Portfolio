...
(function () {
  ...
  const PORTFOLIO_DATA = {
    ...
    current_role: {
      ...
      period: "2025–Present",
      description:
        "Solo-developed and shipped DesignCustomBox (designcustombox.com) — a live 3D custom packaging e-commerce platform — in just 7 days using Next.js 15, Three.js, and Node.js.",
    },
    experience: [
      {
        ...
        period: "2025–Present",
        current: true,
        tech: ["Next.js 15", "Three.js", "Node.js", "MongoDB", "TypeScript"],
        responsibilities: [
          "Solo-developed and shipped DesignCustomBox (designcustombox.com) — a live 3D custom packaging e-commerce platform — in just 7 days",
          "Full-stack ownership from architecture to deployment",
        ],
      },
      {
        role: "AI-First Web Dev Intern",
        org: "Nexium",
        period: "Jul–Aug 2025",
        tech: ["Next.js 15", "GPT-4", "TypeScript", "Supabase", "Tailwind"],
        achievement: "30% resume-job matching accuracy improvement",
        responsibilities: [
          "Built AI-powered Resume Tailor with GPT-4",
          "Developed Blog Summarizer with NLP",
          "Built QuoteGen AI app",
        ],
      },
      {
        role: "Software Dev Trainee",
        org: "Bright Network (Technology Academy)",
        period: "Sep 2024",
      ...
      },
      {
        ...
        achievement:
          "25% decision-making improvement, 30% pipeline speed increase",
        responsibilities: [
      ...
      },
      {
        ...
        org: "Kashf Foundation",
        period: "Jul–Aug 2024",
        tech: ["SQL", "SQL Server", "Android", "Dashboard", "Analytics"],
        achievement: "40% SQL query response time reduction",
        responsibilities: [
          "Built real-time compliance dashboard with KPI monitoring",
          "Optimized SQL queries",
          "Enhanced Android app UI/UX with Material Design",
        ],
      },
    ],
    projects: [
      {
        ...
        featured: true,
        description:
          "AI-powered resume optimization platform using GPT-4 to match job descriptions with 30% accuracy improvement.",
        long_description:
          "Advanced full-stack application built with Next.js 15 leveraging OpenAI's GPT-4 API for intelligent resume optimization. Analyzes job descriptions using NLP and automatically tailors resumes to maximize ATS compatibility.",
        technologies: [
          "Next.js 15",
          "TypeScript",
          "GPT-4",
      ...
      },
      {
        ...
        category: ["ml", "nlp", "web"],
        description:
          "Full-stack AI web app for intelligent NLP summarization with Urdu translation support.",
        long_description:
          "Intelligent text summarization platform using transformer models and NLP to extract key information from articles. Supports multi-language including Urdu translation.",
        technologies: [
          "Next.js",
          "MongoDB",
          "NLP",
      ...
      },
      {
        ...
        description:
          "Big data pipeline processing 13.5M+ vehicle records with 98.75% data quality score.",
        long_description:
          "Enterprise-grade data engineering solution handling massive datasets for urban analytics. Implements ETL pipelines, data quality checks, and generates actionable insights for city planning.",
        technologies: [
          "Python",
          "Pandas",
          "NumPy",
      ...
      },
      {
        ...
        description:
          "Decentralized voting application on Ethereum ensuring transparent, tamper-proof elections.",
        long_description:
          "Revolutionary blockchain-based voting system leveraging Ethereum smart contracts for transparent yet anonymous voting. Features include real-time counting and audit trails.",
        technologies: [
          "Solidity",
          "Web3.js",
          "React",
      ...
      },
      {
        ...
        description:
          "Deep learning model generating image captions using CNN-LSTM architecture with 0.875 BLEU score.",
        long_description:
          "Sophisticated computer vision and NLP system combining CNNs for feature extraction with LSTMs for sequence generation.",
        technologies: [
          "TensorFlow",
          "Keras",
          "CNN",
      ...
      },
      {
        ...
        description:
          "Full-stack educational platform connecting students with tutors with real-time chat and scheduling.",
        long_description:
          "Complete learning management system with advanced features like real-time chat, intelligent tutor matching, and secure payment processing.",
        technologies: [
          "React",
          "Node.js",
          "Express",
      ...
      },
      {
        ...
        category: ["web", "ai"],
        description:
          "AI-inspired quote generator with topic-based generation and modern UI design.",
      ...
      },
      {
        ...
        category: ["data", "ml"],
        description:
          "Satellite data analysis using NDVI to monitor deforestation and urban sprawl with 90%+ accuracy.",
      ...
      },
      {
        ...
        category: ["web"],
        description:
          "Smart gym platform with workout tracker, nutrition panel, BMI calculator, and AI chatbot trainer.",
      ...
      },
      {
        ...
        category: ["web"],
        description:
          "Responsive movie browsing app with TMDb API integration and advanced filtering.",
      ...
      },
      {
        ...
        description:
          "Automated Azure infrastructure deployment using modular Bicep templates.",
      ...
      },
      {
        ...
        category: ["web", "full-stack"],
        description:
          "Complete e-commerce platform with cart, authentication, admin panel, and payment processing.",
    ...
    certifications: [
      {
        ...
        date: "January 2025",
        description:
          "Completed intensive internship program focusing on building AI-powered web applications",
      ...
      },
      {
        ...
        date: "June - July 2024",
        description:
          "Completed data science internship with focus on predictive modeling and analytics",
      ...
      },
      {
        ...
        description:
          "Completed internship focusing on dashboard development and database optimization",
      ...
      },
      {
        ...
        date: "September 2024",
        description:
          "Completed intensive software development training program",
        skills: [
...
MERN Stack Developer at NEXTSTAC, solo-developed and shipped DesignCustomBox (designcustombox.com) in 7 days

EXPERIENCE:
1. MERN Stack Developer at NEXTSTAC (2025-Present) - Solo-shipped DesignCustomBox in 7 days
...
Remember: Be helpful, cite achievements with numbers, always include GitHub links, and guide users to contact Shahzeb for opportunities!`;
          ...
          body: JSON.stringify({
            contents: [
              ...
              },
              {
                ...
                parts: [
                  {
                    text: "I understand. I am the AI assistant for Shahzeb Faisal's portfolio. I will help visitors learn about his skills, projects, and experience with detailed information. How can I help you today?",
                  },
                ],
              },
    ...
    getFallbackResponse(query) {
      ...
      if (
        (q.includes("about shahzeb") ||
          q.includes("who is shahzeb") ||
          (q.includes("shahzeb") && q.includes("faisal"))) &&
        !q.includes("project")
      ) {
        return `Shahzeb Faisal is a MERN Stack Developer from Lahore, Pakistan. Graduated with BS Data Science from FAST NUCES (2021-2025), one of Pakistan's top tech universities. Currently MERN Stack Developer at NEXTSTAC, solo-developed and shipped DesignCustomBox in 7 days. Completed 4 internships (Nexium, CodeAlpha, Kashf, BRIGHT) with proven results: 30% accuracy improvements, 40% optimizations. Built 12+ projects across AI/ML, web development, data science, blockchain. Expertise: Python, JavaScript, TensorFlow, GPT-4, NLP, Next.js, React. OPEN TO WORK - Available immediately for AI/ML, Data Science, and Full-Stack roles! Contact: shahzebfaisal5649@gmail.com | LinkedIn: linkedin.com/in/shahzeb-faisal-8b9190321`;
      }
      ...
      if (
        (q.includes("ml project") ||
          q.includes("machine learning project") ||
...
All demonstrate strong ML/AI capabilities with measurable results!`;
      ...
      if (
        q.includes("nexium") ||
        q.includes("resume tailor") ||
        (q.includes("resume") &&
          (q.includes("project") || q.includes("tailor")))
      ) {
      ...
      if (
        q.includes("election") ||
        (q.includes("dapp") && !q.includes("real estate")) ||
        q.includes("voting")
      ) {
      ...
      if (
        q.includes("quotegen") ||
        (q.includes("quote") && q.includes("gen"))
      ) {
      ...
      if (
        q.includes("movie showcase") ||
        (q.includes("movie") && !q.includes("about"))
      ) {
      ...
      if (
        ...
        (q.includes("shop") && !q.includes("showcase"))
      ) {
      ...
      if (
        q.includes("bright") ||
        q.includes("technology academy") ||
        q.includes("couch to coder")
      ) {
      ...
      if (
        q.includes("each intern") ||
        q.includes("all intern") ||
        (q.includes("detail") && q.includes("intern"))
      ) {
...
Total: 1+ year experience, 4 certifications earned. Currently MERN Stack Developer at NEXTSTAC, solo-developed DesignCustomBox in 7 days.`;
      }
      ...
      if (
        ...
        return `Shahzeb completed his Bachelor of Science in Data Science from FAST National University of Computer & Emerging Sciences (NUCES), Lahore Campus (2021-2025, Graduated). FAST NUCES is one of Pakistan's top technology universities known for excellence in computer science and data science education. Focus areas: Machine Learning, Deep Learning, NLP, Big Data Analytics.`;
      }
      if (q.includes("research")) {
        return `Shahzeb focuses on production-grade systems engineering. While he has no official research publications, he applies rigorous scientific and data-driven methods to develop and optimize high-performance full-stack web applications and machine learning models in industry settings.`;
      }
...
Total: 30+ technologies mastered across all domains!`;
      ...
      if (
        ...
        (q.includes("ai ") && !q.includes("intern") && !q.includes("project"))
      ) {
        return `Shahzeb's ML/AI Expertise: TensorFlow, PyTorch, Scikit-Learn, Keras for deep learning. NLP specialization: GPT-4, BERT, Llama, spaCy, NLTK, Transformers. Computer Vision: CNN, LSTM, image processing. Projects: Resume Tailor (GPT-4), Image Captioning (0.875 BLEU), Blog Summarizer (NLP), Smart City (Big Data). Proven results: 30% accuracy improvements, 0.875 BLEU score, 98.75% data quality.`;
      }
...
Work Preferences: Remote, Hybrid, or On-site in Lahore`;
      ...
      if (
        (q.includes("research") && q.includes("assistant")) ||
        q.includes("esha")
      ) {
        return `Shahzeb focuses on production-grade systems engineering. He has zero research experience or publications and is currently working as a MERN Stack Developer at NEXTSTAC, where he solo-developed and shipped DesignCustomBox (designcustombox.com) in just 7 days.`;
      }
      if (
        q.includes("cgpa") ||
        q.includes("grade") ||
      ...
      if (
        ...
        return `Shahzeb focuses on production-grade web systems. He has zero research experience or publications under any supervisor and is currently working as a MERN Stack Developer at NEXTSTAC, where he solo-developed DesignCustomBox (designcustombox.com) in just 7 days.`;
      }
      if (
        q.includes("social") ||
        q.includes("profile")
...
Currently: MERN Stack Developer at NEXTSTAC (2025-Present) - Solo-shipped DesignCustomBox in 7 days
...
🎯 Key Achievements: 30% accuracy↑, 98.75% quality, 40% optimization↓, 0.875 BLEU score, 13.5M+ records processed, 500+ platform users`;
      ...
      if (
        ...
        return `Hey there! 👋 I'm Shahzeb's AI portfolio assistant. I can tell you about his 12+ projects (Resume Tailor, Smart City, FLEX GYM, Movie Showcase, Election DApp, etc.), 4 internships (Nexium, CodeAlpha, Kashf, BRIGHT), skills (ML/AI, Web, Data Science, Blockchain), current role as a MERN Stack Developer at NEXTSTAC, or how to contact him. What would you like to know?`;
      }
...
💼 Experience: His current role as MERN Stack Developer at NEXTSTAC, or his 4 internships (Nexium, CodeAlpha, Kashf, BRIGHT)
🎓 Education: BS Data Science from FAST NUCES
...
Type 'help' for available commands or ask naturally about anything!`;
  ...
  function initCursor() {
    ...
    const interactiveElements = document.querySelectorAll(
      "a, button, .project-card, .skill-tags span, .filter-btn, input, .timeline-item, .suggestion",
    );
...
╠══════════════════════════════════════════════════════════╣
║                                                           ║
║  💻 MERN STACK DEVELOPER (2025 - Present)                ║
║     NEXTSTAC • Shipped DesignCustomBox in 7 days          ║
║     Full stack Next.js 15, Three.js, Node.js, MongoDB     ║
║                                                           ║
...
╚══════════════════════════════════════════════════════════╝`,
    ...
    init() {
      ...
      document
        .getElementById("terminal-minimize")
        ?.addEventListener("click", () => this.close());
      document
        .getElementById("terminal-maximize")
      ...
      document.addEventListener("keydown", (e) => {
        ...
        if (
          e.key === "Escape" &&
          !this.terminal.classList.contains("terminal-hidden")
        ) {
          this.close();
        }
      });
    ...
    initVoiceRecognition() {
      ...
      if (!SpeechRecognition) {
        ...
        voiceBtn.addEventListener("click", () => {
          this.addLine(
            '<span class="term-error">⚠️ Voice recognition not supported. Try Chrome or Edge.</span>',
          );
        });
        return;
      }
          ...
          (e) => {
            ...
            if (!this.isListening) {
              try {
                ...
                this.addLine(
                  '<span class="term-info">🎤 Listening... Speak now!</span>',
                );
                this.scrollToBottom();
                ...
                this.addLine(
                  '<span class="term-error">⚠️ Could not start voice recognition.</span>',
                );
      ...
      // ════════════════════════════════════════════════════════
        ...
        voiceBtn.addEventListener("click", (e) => {
          ...
          console.log(
            "🖱️ Desktop click detected, isListening:",
            this.isListening,
          );
          ...
          if (!this.isListening) {
            try {
              ...
              console.error("Voice start error:", error);
              this.addLine(
                '<span class="term-error">⚠️ Voice error: ' +
                  error.message +
                  "</span>",
              );
              voiceBtn.classList.remove("listening");
      ...
      this.recognition.onend = () => {
        ...
        if (finalTranscript.trim()) {
          ...
          this.addLine(
            `<span class="term-success">🎤 Heard: "${finalTranscript.trim()}"</span>`,
          );
          AudioSystem.play("success");
      ...
      this.recognition.onerror = (event) => {
        ...
        if (isMobile && window.showMobileNotification) {
          showMobileNotification(
            errorMsg.replace("⚠️ Voice error: ", ""),
            "error",
          );
        }
      };
      ...
      console.log(
        "✅ Voice recognition initialized for",
    ...
    async execute(cmd) {
      ...
      this.addLine(
        `<span class="term-prompt">❯</span> <span class="term-cmd">${this.escapeHtml(cmd)}</span>`,
      );
      ...
      if (this.commands[firstWord]) {
        this.addLine(
          `<pre class="term-response">${this.commands[firstWord]}</pre>`,
        );
      } else {
        ...
        switch (firstWord) {
          ...
          case "sound":
            ...
            this.addLine(
              `<span class="term-success">🔊 Sound ${enabled ? "enabled" : "disabled"}</span>`,
            );
            break;
          case "confetti":
            triggerConfetti();
            this.addLine(
              '<span class="term-success">🎉 Celebration time!</span>',
            );
            break;
          case "matrix":
            toggleMatrix();
            this.addLine(
              '<span class="term-success">🟢 Matrix effect toggled!</span>',
            );
            break;
          case "resume":
            this.addLine(
              '<span class="term-success">📄 Downloading resume...</span>',
            );
            setTimeout(() => {
          ...
          case "github":
            ...
            this.addLine(
              '<span class="term-success">🐙 Opening GitHub...</span>',
            );
            break;
          case "linkedin":
            window.open(
            ...
            this.addLine(
              '<span class="term-success">💼 Opening LinkedIn...</span>',
            );
            break;
          case "email":
            window.location.href = "mailto:shahzebfaisal5649@gmail.com";
            this.addLine(
              '<span class="term-success">📧 Opening email client...</span>',
            );
            break;
          case "repos":
          ...
          case "ai":
            ...
            if (!aiQuery) {
              this.addLine(
                `<div class="t-muted">Usage: ai &lt;your question&gt;<br>Example: ai what projects has Shahzeb built?</div>`,
              );
            } else {
              ...
              (async () => {
                try {
                  const ctx = buildSystemContext(
                    JSON.parse(sessionStorage.getItem("gh_repos_ai") || "[]"),
                  );
                  const history = [
                    { role: "user", parts: [{ text: ctx }] },
                    {
                      ...
                      parts: [
                        {
                          text: "Understood. I am ready to answer questions about Shahzeb Faisal.",
                        },
                      ],
                    },
                  ...
                  this.addLine(
                    `<div class="t-item"><span class="t-gold">Gemini:</span> ${reply}</div>`,
                  );
                } catch (e) {
                  this.addLine(
                    `<div class="t-error">AI unavailable. Email: shahzebfaisal5649@gmail.com</div>`,
                  );
                }
              })();
            }
    ...
    async typewriterEffect(text) {
      ...
      div.innerHTML =
        '<span class="ai-icon">🤖</span> <span class="ai-text"></span>';
  ...
  function initTerminalHint() {
    ...
    hint.innerHTML =
      '<div class="hint-glow"></div><div class="hint-pulse"></div><div class="hint-content"><i class="fas fa-terminal hint-icon"></i><span>Try</span><kbd>Ctrl</kbd><span>+</span><kbd>.</kbd><span>for AI</span></div>';
  ...
  function initParallax() {
    const floatingElements = document.querySelectorAll(
      ".floating-elements .float-item, .floating-elements .float-icon",
    );
  ...
  function initScrollReveal() {
    const elements = document.querySelectorAll(
      ".section-header, .project-card, .timeline-item, .skill-category, .about-content, .about-image, .contact-card",
    );
      ...
      const skillObserver = new IntersectionObserver(
        (entries) => {
          entries.forEach((entry) => {
            if (entry.isIntersecting) {
              document
                .querySelectorAll(".skill-tags span[data-level]")
                .forEach((span, i) => {
  ...
  function initAboutSectionTabs() {
    ...
    cards.forEach((card) => {
      card.addEventListener("click", () => {
        ...
        const pane = document.getElementById("about-" + target);
  ...
  function initSkillsVisualizations() {
    ...
    const ctx = canvas.getContext("2d");
    const skillsData = [
      { name: 'AI / ML',       value: 85, color: '#C9A84C' },
      { name: 'Data Science',  value: 80, color: '#E8C97A' },
      { name: 'Frontend',      value: 75, color: '#C9A84C' },
      { name: 'Backend',       value: 65, color: '#8B6914' },
      { name: 'DevOps',        value: 50, color: '#6B4F10' },
      { name: 'Blockchain',    value: 40, color: '#9A8870' },
    ];
    ...
    function drawBars(progress) {
      ...
      const startY = 30;
      const nameWidth = 140;
      const maxBarWidth = Math.max(100, width - nameWidth - 80);
      ...
      skillsData.forEach((skill, index) => {
        ...
        ctx.fillText(skill.name, 10, y + barHeight / 2);

        const barStartX = nameWidth;
        const currentPercent = skill.value * progress;
        const fillWidth = (currentPercent / 100) * maxBarWidth;
        ...
        drawRoundedRect(ctx, barStartX, y, maxBarWidth, barHeight, 4);
        ctx.fill();
        ctx.stroke();
        ...
        if (fillWidth > 0) {
          ...
          ctx.shadowBlur = 12;
          ctx.fillStyle = "#ffffff";
          ctx.fillRect(barStartX + fillWidth - 2, y, 4, barHeight);
        ...
        ctx.textAlign = "left";
        ctx.textBaseline = "middle";
        ctx.fillText(`${Math.round(currentPercent)}%`, barStartX + maxBarWidth + 15, y + barHeight / 2);
      });
    }
    ...
    function animateStackCards() {
      stackCards.forEach((card) => {
        ...
        const percentEl = card.querySelector(".stack-percent");
        ...
        function updateCounter(now) {
          ...
          const progress = Math.min(elapsed / duration, 1);
          const currentVal = Math.round(progress * percent);
  ...
  function initQuickActions() {
    ...
    document
      ...
      ?.addEventListener("click", () => AudioSystem.toggle());
  ...
  function initInteractionSounds() {
    ...
    document
      .querySelectorAll(".project-card, .social-link, .skill-tags span")
      .forEach((el) => {
      ...
      if (e.key === pattern[current]) {
        ...
        if (current === pattern.length) {
          ...
          if (Terminal.output) {
            Terminal.open();
            Terminal.addLine(
              '<span class="term-success" style="font-size:1.2rem;">🎮 KONAMI CODE!</span>',
            );
          }
        }
      } else {
      ...
      window.addEventListener("load", () => {
        setTimeout(() => {
          ...
          if (perfData) {
            ...
            console.log(
              `⚡ Load: ${(perfData.loadEventEnd - perfData.fetchStart).toFixed(0)}ms`,
            );
            console.log(
              `🎨 DOM: ${(perfData.domContentLoadedEventEnd - perfData.fetchStart).toFixed(0)}ms`,
            );
          }
        }, 0);
      });
  ...
  function initCertificateViewer() {
    ...
    timelineItems.forEach((item) => {
      const company =
        item.querySelector(".company")?.textContent.toLowerCase() || "";
      let certKey = null;
      ...
      if (company.includes("nexium")) certKey = "nexium";
        ...
        company.includes("technology academy") ||
        company.includes("bright")
      )
        certKey = "bright";
      ...
      if (certKey && certificates[certKey]) {
        ...
        certBtn.setAttribute(
          "aria-label",
          `View ${certificates[certKey].title} certificate`,
        );
    ...
    // Add click event listeners to home page certificate cards
    const homeCertCards = document.querySelectorAll(".certifications .cert-card");
    homeCertCards.forEach((card) => {
      ...
      if (certKey && certificates[certKey]) {
        ...
        // Also bind the expand button if present
        const expandBtn = card.querySelector(".view-cert-btn");
        if (expandBtn) {
          expandBtn.addEventListener("click", openModalFn);
        }
      }
    });
  ...
  function initHeroLogoParallax() {
    ...
    heroSection.addEventListener("mousemove", (e) => {
      ...
      logoImg.style.transform = `perspective(800px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) scale(1.05)`;
      logoImg.style.animation = "none"; // pause auto animation during hover
    });

    heroSection.addEventListener("mouseleave", () => {
      logoImg.style.transform = "";
      logoImg.style.animation =
        "heroLogoBreathe 4s ease-in-out infinite, heroLogoTilt 8s ease-in-out infinite";
    });
  }
  ...
  function initHeroScrollAnimation() {
    ...
    window.addEventListener(
      ...
      () => {
        ...
        heroContent.style.transformOrigin = "center top";
      },
      { passive: true },
    );
  }
  ...
  function init() {
    ...
    AudioSystem.init();
    initNavigation();
    initAboutSectionTabs();
    initSkillsVisualizations();
    initTypingEffect();
    ...
    // Check for query parameters to auto-open Terminal or AI Chat on home page
    ...
    if (urlParams.get("chat") === "true") {
      setTimeout(() => {
        if (window.toggleGeminiChat) window.toggleGeminiChat();
      }, 500);
    }
    ...
    console.log(
      "%c✨ Portfolio v7.0 - Enhanced AI System!",
      "color: #6366f1; font-size: 16px; font-weight: bold;",
    );
    console.log(
      "%cPress Ctrl+. for AI Terminal with comprehensive knowledge",
  ...
  function initProjectModals() {
    ...
    const achContainer = document.getElementById(
    ...
    cards.forEach((card) => {
      card.addEventListener("click", (e) => {
        ...
        const pd =
          PORTFOLIO_DATA.projects.find((p) => p.name === projectName) || {};
        ...
        github.href =
          pd.github || card.querySelector(".project-overlay")?.href || "#";
  ...
  // 6. Interactive Command Palette (Ctrl+K) moved to Sidebar.js for cross-page compatibility
...
`;
  console.log(
    asciiArt,
    "color: #d4ff33; font-weight: bold; font-family: monospace;",
  );
  console.log(
    "%cFull Stack AI Developer | FAST NUCES Lahore",
    "color: #d4ff33; font-size: 14px; font-weight: bold;",
  );
  console.log(
    "%c📧 shahzebfaisal5649@gmail.com  |  🐙 github.com/ShahzebFaisal5649",
    "color: #aaa; font-size: 12px;",
  );
  console.log(
    "%c💼 OPEN TO WORK — Available immediately (June 2026)",
    "color: #10b981; font-size: 13px; font-weight: bold;",
  );
  console.log(
    "%c🎮 TIP: Try the Konami code on this page ↑↑↓↓←→←→BA",
    ...
    (entries) => {
      entries.forEach((entry) => {
        ...
        const target = parseInt(
          bar.dataset.level ||
            bar.getAttribute("style")?.match(/(\d+)%/)?.[1] ||
            0,
          10,
        );
        const label = bar
          .closest(".skill-item")
          ?.querySelector(".skill-percentage, .skill-level");
        let current = 0;
  ...
  document
    .querySelectorAll(".skill-bar, .skill-progress")
    .forEach((bar) => counterObserver.observe(bar));
  ...
  (function initFilmGrain() {
    ...
    canvas.style.cssText =
      "position:fixed;top:0;left:0;width:100vw;height:100vh;pointer-events:none;z-index:9998;opacity:0.035;";
      ...
      if (konamiIdx === KONAMI.length) {
        ...
        if (window.heroMesh) {
          if (typeof gsap !== "undefined") {
            gsap.to(window.heroMesh.rotation, {
              y: window.heroMesh.rotation.y + Math.PI * 6,
              duration: 2,
              ease: "power2.out",
            });
          }
        ...
        if (termOutput) {
          ...
          msg.textContent =
            "> [SYSTEM]: Konami sequence detected. Welcome, developer. 🎉";
    ...
    document.querySelectorAll(".project-card").forEach((card) => {
      ...
      card.addEventListener(
        ...
        (e) => {
          ...
          const liveLink = card.querySelector(
            'a[href]:not([href*="github"])',
          )?.href;
  ...
  window.initStackDistribution =
    typeof initStackDistribution !== "undefined" ? initStackDistribution : null;
  window.initSkillsRadar =
    typeof initSkillsRadar !== "undefined" ? initSkillsRadar : null;
})();
